...
from Panjabi.mainForm import Ui_MainWindow
from Panjabi.MainQScintilla import MainQScintilla
from Panjabi.TypingQScintilla import TypingQScintilla
from DB import DB
...
class clsmainForm(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.btn_1.setIcon(QtGui.QIcon('panjabifontImage/x_1.png'))
        self.ui.btn_1.setIconSize(QtCore.QSize(60, 60))

        self.ui.btn_2.setIcon(QtGui.QIcon('panjabifontImage/x_2.png'))
        self.ui.btn_2.setIconSize(QtCore.QSize(60, 60))

        self.ui.btn_3.setIcon(QtGui.QIcon('panjabifontImage/x_3.png'))
        self.ui.btn_3.setIconSize(QtCore.QSize(60, 60))

        self.ui.btn_4.setIcon(QtGui.QIcon('panjabifontImage/x_4.png'))
        self.ui.btn_4.setIconSize(QtCore.QSize(60, 60))

        self.ui.btn_5.setIcon(QtGui.QIcon('panjabifontImage/x_5.png'))
        self.ui.btn_5.setIconSize(QtCore.QSize(60, 60))

        self.ui.btn_6.setIcon(QtGui.QIcon('panjabifontImage/x_6.png'))
        self.ui.btn_6.setIconSize(QtCore.QSize(60, 60))

        self.ui.btn_7.setIcon(QtGui.QIcon('panjabifontImage/x_7.png'))
        self.ui.btn_7.setIconSize(QtCore.QSize(60, 60))

        self.ui.btn_8.setIcon(QtGui.QIcon('panjabifontImage/x_8.png'))
        self.ui.btn_8.setIconSize(QtCore.QSize(60, 60))

        self.ui.btn_9.setIcon(QtGui.QIcon('panjabifontImage/x_9.png'))
        self.ui.btn_9.setIconSize(QtCore.QSize(60, 60))

        self.ui.btn_0.setIcon(QtGui.QIcon('panjabifontImage/x_0.png'))
        self.ui.btn_0.setIconSize(QtCore.QSize(60, 60))

        rows = self.db.runSelect("select Passage from panjabi where Title='" + GlobleData.lesson + "'")
        for row in rows:
