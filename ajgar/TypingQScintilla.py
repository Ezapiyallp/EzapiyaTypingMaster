...
class MyLexer(QsciLexerCustom):
    ...
    def __init__(self, parent):
        ...
        self.setDefaultFont(QFont("ezapiya1", 14))
        ...
        # ---------------------------
        self.setFont(QFont("ezapiya1", 14, weight=QFont.Bold), 0)   # Style 0: Consolas 14pt
        self.setFont(QFont("ezapiya1", 14, weight=QFont.Bold), 1)   # Style 1: Consolas 14pt
        self.setFont(QFont("ezapiya1", 14, weight=QFont.Bold), 2)   # Style 2: Consolas 14pt
        self.setFont(QFont("ezapiya1", 14, weight=QFont.Bold), 3)   # Style 3: Consolas 14pt
