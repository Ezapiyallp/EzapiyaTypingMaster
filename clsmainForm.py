...
from MainQScintilla import MainQScintilla
from TypingQScintilla import TypingQScintilla
from DB import DB
...
class clsmainForm(QMainWindow):
    def __init__(self):
        ...
        self.txtMainData.setText(
            "wsx.QAZ, 1234' Edcvbnm/r fgjk?..;plmkj hgfd{Wrtg vnf}uyeur y|dgfbcnb jhuyrto wmvzx cvbnm. Pefn` 123!# "
            "cmbwbdej gesc bhrs#$u yrcmuhg ghtuye rfyrutcve ujhcbwghc fvukui% ^jhgh&* ()+HyGH+")
        self.txtTypingData.setMainText(
            "wsx.QAZ, 1234' Edcvbnm/r fgjk?..;plmkj hgfd{Wrtg vnf}uyeur y|dgfbcnb jhuyrto wmvzx cvbnm. Pefn` 123!# "
            "cmbwbdej gesc bhrs#$u yrcmuhg ghtuye rfyrutcve ujhcbwghc fvukui% ^jhgh&* ()+HyGH+")
