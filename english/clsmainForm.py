...
from english.mainForm import Ui_MainWindow
from english.MainQScintilla import MainQScintilla
from english.TypingQScintilla import TypingQScintilla
from DB import DB
...
class clsmainForm(QMainWindow):
    ...
    def __init__(self):
        ...
        rows = self.db.runSelect("select Passage from English where Title='" + GlobleData.lesson + "'")
        for row in rows:
