...
from hindi.mainForm import Ui_MainWindow
from hindi.MainQScintilla import MainQScintilla
from hindi.TypingQScintilla import TypingQScintilla
from DB import DB
...
class clsmainForm(QMainWindow):
    ...
    def __init__(self):
        ...
        rows = self.db.runSelect("select Passage from hindi where Title='" + GlobleData.lesson + "'")
        for row in rows:
